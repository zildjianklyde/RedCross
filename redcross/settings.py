...
SECRET_KEY = 'django-insecure-zu(&0dwzl@-oa@!=7u9u@vjy^36ug@4*0)!k*#qhg1oqgc%1@b'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your-email@redcross.com'
EMAIL_HOST_PASSWORD = 'your-email-password'
DEFAULT_FROM_EMAIL = 'no-reply@redcross.com'

DJANGO_CRON_CLASSES = [
    "app.cron.NotifyEligibleDonors",
]